...
class OrderTestCase(TestCase):
    ...
    def test_create_order_with_products(self):
        ...
        product1 = Product.objects.create(name='Product 1', price=2000, amount=PRODUCT_1_AMOUNT)
        product2 = Product.objects.create(name='Product 2', price=10000, amount=PRODUCT_2_AMOUNT)
        order1 = Order.objects.create(customer=self.user1)

        po1 = Product_Order.objects.create(order=order1, 
                                           product=product1, 
                                           product_amount=PRODUCT_1_AMOUNT)
        ...
        po2 = Product_Order.objects.create(order=order1,
                                           product=product2,
                                           product_amount=PRODUCT_2_AMOUNT)
    ...
    def test_create_order_with_grt_amount_than_allowed(self):
        ...
        product1 = Product.objects.create(name='Product 1', price=2000, amount=ALLOWED_AMOUNT)
        order1 = Order.objects.create(customer=self.user1)
        
        po1 = Product_Order.objects.create(order=order1,
                                           product=product1,
                                           product_amount=ALLOWED_AMOUNT)
        self.assertEqual(po1.product_amount, ALLOWED_AMOUNT)

        po2 = Product_Order(order=order1, product=product1, product_amount=RESTRICTED_AMOUNT)
